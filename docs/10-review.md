...
If you want to extend Tailspin Toys from the terminal, continue with the optional [Foundry Backer Concierge series][foundry]. To compare other environments, including VS Code, the GitHub Copilot app, and the Copilot cloud agent, explore the full [Copilot Workshops catalog][catalog].
...
[catalog]: https://github-samples.github.io/copilot-workshops/
